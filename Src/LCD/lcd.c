...
void LCD_Display_RealStatus(SwitchTypeDef *sw, uint16_t version, float oilTemp, uint16_t deviceStatus, uint8_t isRefresh)
{
    ...
    {
        LCD_Refresh_Screen();
        LCD_Display_One_Hanzi(0, 0, 4, &FONT_Capital[12][16],16);//M
        switch(SWITCH_TYPE)
        {
            case 0x01:
            LCD_Display_One_Hanzi(0, 0, 12, &FONT_Capital[25][16],16);//Z
            LCD_Display_One_Hanzi(0, 0, 20, &FONT_Number[1][16],16);
            LCD_Display_One_Hanzi(0, 0, 28, &FONT_Number[0][16],16);
            LCD_Display_One_Hanzi(0, 0, 36, &FONT_Number[0][16],16);
            LCD_Display_One_Hanzi(0, 0, 44, &FONT_Number[5][16],16);
            break;
            case 0x02:
            LCD_Display_One_Hanzi(0, 0, 12, &FONT_Capital[25][16],16);//Z
            LCD_Display_One_Hanzi(0, 0, 20, &FONT_Number[1][16],16);
            ...
            LCD_Display_One_Hanzi(0, 0, 28, &FONT_Number[0][16],16);
            LCD_Display_One_Hanzi(0, 0, 36, &FONT_Number[0][16],16);
            LCD_Display_One_Hanzi(0, 0, 44, &FONT_Number[9][16],16);
            break;
            case 0x04:
            LCD_Display_One_Hanzi(0, 0, 12, &FONT_Capital[25][16],16);//Z
            LCD_Display_One_Hanzi(0, 0, 20, &FONT_Number[1][16],16);
            LCD_Display_One_Hanzi(0, 0, 28, &FONT_Number[0][16],16);
            LCD_Display_One_Hanzi(0, 0, 36, &FONT_Number[1][16],16);
            LCD_Display_One_Hanzi(0, 0, 44, &FONT_Number[7][16],16);
            break;
            case 0x05:
            LCD_Display_One_Hanzi(0, 0, 12, &FONT_Capital[25][16],16);//Z
            LCD_Display_One_Hanzi(0, 0, 20, &FONT_Number[1][16],16);
            ...
            break;
            case 0x11:
            LCD_Display_One_Hanzi(0, 0, 12, &FONT_Capital[1 ][16],16);//B
            LCD_Display_One_Hanzi(0, 0, 20, &FONT_Number[3][16],16);
            LCD_Display_One_Hanzi(0, 0, 28, &FONT_Number[0][16],16);
            LCD_Display_One_Hanzi(0, 0, 36, &FONT_Number[0][16],16);
            LCD_Display_One_Hanzi(0, 0, 44, &FONT_Number[5][16],16);
            break;
            ...
            break;
            case 0x21:
            LCD_Display_One_Hanzi(0, 0, 12, &FONT_Capital[24][16],16);//Y
            LCD_Display_One_Hanzi(0, 0, 20, &FONT_Number[1][16],16);
            LCD_Display_One_Hanzi(0, 0, 28, &FONT_Number[0][16],16);
            LCD_Display_One_Hanzi(0, 0, 36, &FONT_Number[0][16],16);
            LCD_Display_One_Hanzi(0, 0, 44, &FONT_Number[5][16],16);
            ...
            case 0x23:
            LCD_Display_One_Hanzi(0, 0, 12, &FONT_Capital[24][16],16);//Y
            LCD_Display_One_Hanzi(0, 0, 20, &FONT_Number[6][16],16);
            LCD_Display_One_Hanzi(0, 0, 28, &FONT_Number[0][16],16);
            LCD_Display_One_Hanzi(0, 0, 36, &FONT_Number[0][16],16);
            LCD_Display_One_Hanzi(0, 0, 44, &FONT_Number[3][16],16);
            break;
            case 0x24:
            LCD_Display_One_Hanzi(0, 0, 12, &FONT_Capital[24][16],16);//Y
            LCD_Display_One_Hanzi(0, 0, 20, &FONT_Number[6][16],16);
        ...
        LCD_Display_One_Hanzi(0, 0, 52, &FONT_Capital[17][16],16);//R
        LCD_Display_One_Hanzi(0, 0, 60, &FONT_Number[1][16],16);  //1
        LCD_Display_One_Hanzi(0, 0, 68, &FONT_Number[1][16],16);  //1
        
        LCD_Display_One_Hanzi(0, 0, 84, &FONT_Capital[21][16],16);//V
        LCD_Display_One_Hanzi(0, 0, 92, &FONT_Number[Font_Number_Array(version/1000) ][16],16);
        LCD_Display_One_Hanzi(0, 0, 100, &FONT_Number[Font_Number_Array((version%1000)/100) ][16],16);
        LCD_Display_One_Hanzi(0, 0, 108, &FONT_Number[Font_Number_Array((version%100)/10) ][16],16);
        LCD_Display_One_Hanzi(0, 0, 116, &FONT_Number[Font_Number_Array(version%10) ][16],16);
        ...
        LCD_Display_One_Hanzi(1, 6, 62, &FONT_Chinese[68][16], 16);
        LCD_Display_One_Hanzi(1, 6, 78, &FONT_Chinese[28][16], 16);
    ...
    LCD_Display_One_Hanzi(0, 6, 100, &FONT_Number[Font_Number_Array(((sw->currentCapStat) >> 1) & 0x01)][16],16); 
    LCD_Display_One_Hanzi(0, 6, 108, &FONT_Characters[2][16], 16);
    LCD_Display_One_Hanzi(0, 6, 116, &FONT_Number[Font_Number_Array((sw->currentCapStat) & 0x01)][16],16);
}
/*****************************************************************************
    ...
    switch(lcdStatus->monitorCurrentPage)
    {
        case 1:
            for(i = 1 ; i < 4; i++)
            {
                if(lcdStatus->isRefresh == 0)
                {
                    ...
                    if(i == 3)
                        LCD_Display_One_Hanzi(0, 2*i, 20, &FONT_Capital[0 ][16], 16);
                    else
                        LCD_Display_One_Hanzi(0, 2*i, 20, &FONT_Capital[i ][16], 16);
                    LCD_Display_One_Hanzi(0, 2*i, 28, &FONT_Characters[1][16], 16);
                }
                if(i == 1 && telemetry->sample.ua < 12990)
                    temp = (uint32_t)(telemetry->sample.ua);
                else if(i == 2 && telemetry->sample.ub < 12990)
                    temp = (uint32_t)(telemetry->sample.ub);
                else if(i == 3 && telemetry->sample.uc < 12990)
                    temp = (uint32_t)(telemetry->sample.uc);
                if(temp < 99999)
                {
                    if(temp > 9999)
                        LCD_Display_One_Hanzi(0, 2*i, 36, &FONT_Number[Font_Number_Array(temp/10000)][16], 16);
                    else
                        LCD_Display_One_Hanzi(0, 2*i, 36, &FONT_Cap[0][16], 16);
                    if(temp > 999)
                        LCD_Display_One_Hanzi(0, 2*i, 44, &FONT_Number[Font_Number_Array((temp%10000)/1000)][16], 16);
                    else
                        LCD_Display_One_Hanzi(0, 2*i, 44, &FONT_Cap[0][16], 16);
                    if(temp > 99)
                        LCD_Display_One_Hanzi(0, 2*i, 52, &FONT_Number[Font_Number_Array((temp%1000)/100)][16], 16);
                    else
                        LCD_Display_One_Hanzi(0, 2*i, 52, &FONT_Cap[0][16], 16);
                    if(temp > 9)
                        LCD_Display_One_Hanzi(0, 2*i, 60, &FONT_Number[Font_Number_Array((temp%100)/10)][16], 16);
                    else
                        LCD_Display_One_Hanzi(0, 2*i, 60, &FONT_Cap[0][16], 16);
        ...
        case 2:
            for(i = 1 ; i < 4; i++)
            {
                ...
                if(i == 1 && telemetry->sample.ia < 10000)
                    temp = (uint32_t)(telemetry->sample.ia*10);
                else if(i == 2 && telemetry->sample.ib < 10000)
                    temp = (uint32_t)(telemetry->sample.ib*10);
                else if(i == 3 && telemetry->sample.ic < 10000)
                    temp = (uint32_t)(telemetry->sample.ic*10);
                if(temp < 99999)
                {
                     if(temp > 9999)
                        LCD_Display_One_Hanzi(0, 2*i, 36, &FONT_Number[Font_Number_Array(temp/10000)][16], 16);
                    ...
                    LCD_Display_One_Hanzi(0, 2*i, 68,  &FONT_Characters[0][16], 16);

                    LCD_Display_One_Hanzi(0, 2*i, 72, &FONT_Number[Font_Number_Array(temp%10)][16], 16);
                } 
            }
        break;
        case 3:
            for(i = 1 ; i < 4; i++)
            {
                ...
                if(i == 1)
                {
                    if(telemetry->sample.pa < 0)
                        ...
                        sign = 0;
                    temp = (uint32_t)(telemetry->sample.pa * 10);
                }
                else if(i == 2)
                {
                    if(telemetry->sample.pb < 0)
                        ...
                        sign = 0;
                    temp = (uint32_t)(telemetry->sample.pb * 10);
                }
                else if(i == 3)
                {
                    if(telemetry->sample.pc < 0)
                        ...
                        sign = 0;
                    temp = (uint32_t)(telemetry->sample.pc * 10);
                }
                if(sign == 1)
            ...
            for(i = 1 ; i < 4; i++)
            {
                ...
                if(i == 1)
                {
                    if(telemetry->sample.qa < 0)
                        ...
                        sign = 0;
                    temp = (uint32_t)(telemetry->sample.qa * 10);
                }
                else if(i == 2)
                {
                    if(telemetry->sample.qb < 0)
                        ...
                        sign = 0;
                    temp = (uint32_t)(telemetry->sample.qb * 10);
                }
                else if(i == 3)
                {
                    if(telemetry->sample.qc < 0)
                        ...
                        sign = 0;
                    temp = (uint32_t)(telemetry->sample.qc * 10);
                }
                if(sign == 1)
                    LCD_Display_One_Hanzi(0, 2*i, 28, &FONT_Characters[2][16], 16);
                else
...
void LCD_Display_Control(LCDStatusTypeDef *lcdStatus, SwitchTypeDef *sw)
{
    ...
    switch(lcdStatus->controlCurrentPage)
    {
        ...
        case 2:
            if(lcdStatus->isRefresh == 0)
            {
                LCD_Display_One_Hanzi(1, 0, 36, &FONT_Chinese[68][16], 16); 
                LCD_Display_One_Hanzi(1, 0, 52, &FONT_Chinese[28][16], 16);
                LCD_Display_One_Hanzi(1, 0, 68, &FONT_Chinese[16][16], 16);
                LCD_Display_One_Hanzi(1, 0, 84, &FONT_Chinese[18][16], 16);

                LCD_Display_One_Hanzi(0, lcdStatus->capSelect*2 +2, 4 , &FONT_Characters[2][16],16);
                LCD_Display_One_Hanzi(0, lcdStatus->capSelect*2 +2, 12, &FONT_Characters[3][16],16);
    
                LCD_Display_One_Hanzi(1, 2, 20, &FONT_Chinese[68][16], 16);
                LCD_Display_One_Hanzi(1, 2, 36, &FONT_Chinese[28][16], 16); 
                LCD_Display_One_Hanzi(1, 2, 52, &FONT_Chinese[76][16], 16);
                LCD_Display_One_Hanzi(1, 2, 68, &FONT_Chinese[78][16], 16);
                LCD_Display_One_Hanzi(0, 2, 84, &FONT_Characters[1 ][16], 16);

                LCD_Display_One_Hanzi(0, 2, 100, &FONT_Number[Font_Number_Array(((sw->currentCapStat) >> 1) & 0x01)][16],16); 
                LCD_Display_One_Hanzi(0, 2, 108, &FONT_Number[Font_Number_Array((sw->currentCapStat) & 0x01)][16],16);
            }
            if(lcdStatus->isRefresh == 0)
            {
                LCD_Display_One_Hanzi(1, 4, 20, &FONT_Chinese[72][16], 16);
                LCD_Display_One_Hanzi(1, 4, 44, &FONT_Chinese[68][16], 16);
                LCD_Display_One_Hanzi(1, 4, 68, &FONT_Chinese[28][16], 16);

                LCD_Display_One_Hanzi(1, 6, 20, &FONT_Chinese[74][16], 16);
                LCD_Display_One_Hanzi(1, 6, 44, &FONT_Chinese[68][16], 16);
                LCD_Display_One_Hanzi(1, 6, 68, &FONT_Chinese[28][16], 16);
...
/**********************************************************/ 
                lcdStatus->capSelect = 0;   //确认动作后，调容上下选择箭头复位 
                LCD_Display_Control(lcdStatus, sw);
            }
        break;
        default:;
