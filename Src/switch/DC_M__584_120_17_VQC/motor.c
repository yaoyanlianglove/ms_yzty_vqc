...
/*****************************************************************************
 ...
 Return      : None
 *****************************************************************************/
float Motor_Speed_Up(float dutyCycle, uint8_t motorType)
{
    float R_STEP;
...
/*****************************************************************************
 ...
 Return      : None
 *****************************************************************************/
float Motor_Slow_Down(float dutyCycle, uint8_t motorType)
{
    float R_STEP;
    if(motorType == MOTOR_X)
        R_STEP = X_R_STEP;
...
{
    uint16_t R_SPEED_UP_TH;
    uint16_t R_SLOW_DOWN_TH;
    if(motorType == MOTOR_X)
    {
        R_SPEED_UP_TH  = X_R_SPEED_UP_TH;
        R_SLOW_DOWN_TH = X_R_SLOW_DOWN_TH;
    }
    else
    {
        R_SPEED_UP_TH  = Q_R_SPEED_UP_TH;
        R_SLOW_DOWN_TH = Q_R_SLOW_DOWN_TH;
    }

    if(r < (R_SPEED_UP_TH))
    {
        motor->dutyCycle = Motor_Speed_Up(motor->dutyCycle, motorType);
    }
    else if(r > (R_SLOW_DOWN_TH))
    {
        motor->dutyCycle = Motor_Slow_Down(motor->dutyCycle, motorType);
    }
}
/************************ZXDQ *****END OF FILE****/
